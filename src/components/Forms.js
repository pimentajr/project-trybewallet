...
import { fetchValues, newExpensesAction } from '../actions/index';
  ...
  render() {
    ...
    return (
      <form>
        <label htmlFor="Valo">
          Valor
          <input id="Valo" type="text" name="value" onChange={ (e) => this.handler(e) } />
        </label>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  expenses:
  (payload, id) => dispatch(newExpensesAction(payload, id)),
});
